...
> = {
  ...
  disposition: { label: 'Stage / Status', help: 'Sets the lead stage: New, Contacted/Open, Interested, Qualified, Visit Done, Meeting Done, Negotiation Done, Booking Done, Agreement Done, Prospect, or Failed' },
