    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="flex gap-0">
        ...
        <div className="flex-1 p-3 space-y-3">
                            ...
                            <div className="relative">
                              ...
                              >
                                ...
                                {/* Source list mirrors FAILED_REASONS in LeadList so the
                                    ...
                                    drift out of sync. */}
                                {['RNR', 'Not Responding', 'Not Interested', 'Budget Issue', 'Location Issue', 'Timeline Issue', 'Competition', 'Not Enquired', 'Invalid Number', 'Other'].map((r) => (
          ...
          {/* ── Follow-ups — lives at the very bottom of the main content column
              by product decision: Status Notes are consulted more frequently
              (every call / edit) so they stay near the top, and follow-ups are
              a forward-looking tool reps configure less often. ────────────── */}
